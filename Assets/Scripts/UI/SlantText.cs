...
public class SlantText : MonoBehaviour {
    ...
    public void OnEnable() {
        UnityEngine.TextCore.Text.TextEventManager.TEXT_CHANGED_EVENT.Add(MoveVerts);
    }

    public void OnDisable() {
        UnityEngine.TextCore.Text.TextEventManager.TEXT_CHANGED_EVENT.Remove(MoveVerts);
    }
